...
### Event Coordinator | Video Game Development Club @ UC San Diego
- Wrote formal proposals for club events
- Created itemized lists and budgets for each event
- Communicated across different levels of administration

### Event Coordinator | EnVisionaries @ UC San Diego
- Wrote formal proposals for club events
- Reached out to and personally worked with other affiliated clubs
- Created itemized lists and budgets for each event

### Program President | COSMOS @ Martin Luther King High School 
- Supported and supervised team of 45 high school STEM interns.
- Provided academic advising and revision for interns' research papers and projects
- Orchestrated positive media coverage as the public face of the program

### Club President | King Conservatory of Music @ Martin Luther King High School
- Founded and organized a new club on campus
...
- Pitch experiment ideas to the PI

### Data Science Lab Intern | Dr. Eamonn Keogh’s Lab @ University of California, Riverside
- Compiled, manipulated, and analyzed data with MATLAB
...
### Tutor | Women In Engineering @ Martin Luther King High School
- Taught AP Calculus AB, SAT Math, Competitive Math, and High School Biology
- Developed individually-tailored material for students with autism and/or ADHD
- Identified lagging skills and correct weaknesses, and made tutoring sessions based on student's age, preferences, and learning style

### Science Olympiad Tutor | Science Olympiad @ Martin Luther King High School 
- Taught Game Design, Cryptology, Cybersecurity, and Ornithology
- Implemented fun and engaging learning activities
- Supported students with academic burnout

### CS Workshop Lead | Women in Engineering @ Martin Luther King High School 
- Taught introductory Scratch, MIT App Inventor, and Java (children ages 4 - 8)
- Led creative group activities to engage students in course material
- Inspired students to pursue further education in CS and/or Engineering

### Piano Tutor | King Conservatory of Music @ Martin Luther King High School 
...
- Assisted in earning NRT in Integrated Computational Entomology for "A Computational System to Support Fully Automated Mark-Recapture Studies of Ants".
- Earned NCWIT Award for Aspirations in Computing and Yale Engineering Award for "Machine Learning & Music Composition"
- 1st Place Mathematics Division for "Music Measure Theory" @ Riverside County Science & Engineering Fair
